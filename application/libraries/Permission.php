 ...
 * @copyright           Copyright (c) 2018, Mesquitadev.
 * @since       Version 1.0
 * v... Visualizar
 * e... Editar
...
class Permission
{
    ...
    var $table = 'permissions';//Nome tabela onde ficam armazenadas as permissões
    var $pk = 'id';// Nome da chave primaria da tabela
    var $select = 'permissions';// Campo onde fica o array de permissoes.
